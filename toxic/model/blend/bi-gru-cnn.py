...
embedding_path = '/Users/guoxinli/I/data/data/glove.twitter.27B/glove.twitter.27B.200d.txt'
embed_size = 200
max_features = 100000
max_len = 150
...
train = train["comment_text"].fillna("no comment").values
test = test["comment_text"].fillna("no comment").values
...
test = tk.texts_to_sequences(raw_text_test)
...
submission.to_csv('/Users/guoxinli/I/data/data/submission_bigru_cnn.csv', index = False)
