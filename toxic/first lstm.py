...
from keras.layers import GRU, LSTM, Bidirectional, GlobalMaxPool1D, Dropout, GlobalAveragePooling1D, concatenate
...
train = pd.read_csv("/Users/guoxinli/I/data/data/train.csv")
test = pd.read_csv("/Users/guoxinli/I/data/data/test.csv")
...
sample_submission.to_csv("/Users/guoxinli/I/data/data/baseline_conca_two_GRU.csv", index=False)