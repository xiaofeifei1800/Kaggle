...
def main():
    ...
    #
    # df_train = pd.read_csv(input_folder + 'train_features.csv', encoding="ISO-8859-1")
    ...
    # X_train.to_csv(input_folder+"x_train_0.15.csv", index=False)
    # y_train_s.to_csv(input_folder+"y_train_0.15.csv", index=False)
    ...
    # df_test = pd.read_csv(input_folder + 'test_features.csv', encoding="ISO-8859-1")
    ...
    # x_test.to_csv(input_folder+"x_test_0.15.csv", index=False)
    ...
    sub.to_csv(input_folder + 'predictions_git.csv', index=False)
