...
x = Bidirectional(GRU(140, return_sequences=True,dropout=0.3,recurrent_dropout=0.3))(x)
...
model.compile(loss='binary_crossentropy',optimizer=Nadam(lr=1e-3),metrics=['accuracy'])
...
submission.to_csv('/Users/guoxinli/I/data/data/submission_twitter_v1_conv.csv', index=False)
