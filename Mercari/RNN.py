...
from keras import backend as Kx
...
train_df = pd.read_table('/Users/guoxinli/I/data/mercari/train.tsv')
test_df = pd.read_table('/Users/guoxinli/I/data/mercari/test.tsv')
...
submission.to_csv("/Users/guoxinli/I/data/mercari/rnn_ridge_submission_best.csv", index=False)
