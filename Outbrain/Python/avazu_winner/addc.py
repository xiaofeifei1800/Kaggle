...
# A, paths
train = '/Users/xiaofeifei/I/Kaggle/train_pre_1'               # path to training file
...
#interactions
inter_s = "ac,af,bc,bf,bi,bk,ck,cm,cn,fk,fm,fn,tc,tf,ic,if,in,jc,jf,jq,xc,xf,yc,yf,zc,zf,1c,1f,2c,2f,3c,3f,4c,4f,xy,xz,x1,x2,x3,x4"

inter = []
featdict = {"a":"C1","b":"banner_pos","c":"site_id","d":"site_domain","e":"site_category","f":"app_id","g":"app_domain","h":"app_category","i":"device_id","j":"ips","k":"device_model","l":"device_type","m":"device_conn_type","n":"C14","o":"C15","p":"C16","q":"C17","r":"C18","s":"C19","t":"C20","u":"C21","x":"C22","y":"C23","z":"C24","1":"C25","2":"C26","3":"C27","4":"C28"}
