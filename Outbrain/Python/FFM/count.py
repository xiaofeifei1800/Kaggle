...
parser.add_argument('/Users/xiaofeifei/GitHub/Kaggle/Outbrain/Python/format_train.csv', type=str)
args = vars(parser.parse_args())

counts = collections.defaultdict(lambda : [0, 0, 0])

for i, row in enumerate(csv.DictReader(open(args['/Users/xiaofeifei/GitHub/Kaggle/Outbrain/Python/format_train.csv'])), start=1):
    label = row['Label']
    for j in range(1, 27):
        field = 'C{0}'.format(j)
        value = row[field]
