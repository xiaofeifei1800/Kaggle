...
def processDataMK(in_file_name, cust_dict, lag_cust_dict, total_dict):
    x_vars_list = []
    y_vars_list = []
    ...
    for row in csv.DictReader(in_file_name):
        ...
        if row['fecha_dato'] == '2016-06-28':
            ...
            x_vars_list.append(x_vars + prev_target_list + lag_target_list + total_list)
