...
cat_lagcols = ['segmento',"ind_nuevo","indrel","indrel_1mes","tiprel_1mes","indresi","ind_actividad_cliente"]
...
def processDataMK(in_file_name, cust_dict, lag_cust_dict, lag_feature):
	...
	for row in csv.DictReader(in_file_name):
		...
		if row['fecha_dato'] == '2016-06-28':
			...
			lag_feature_list = lag_feature.get(cust_id, [0.3162,a,b,0,0.0679,0,2,2,2,0,0,0,2])
...
if __name__ == "__main__":
	...
	x_vars_list, y_vars_list, cust_dict, lag_cust_dict,lag_feature = processDataMK(test_file, cust_dict, lag_cust_dict,lag_feature)
	...
	# param1['subsample'] = 0.7
	# param1['colsample_bytree'] = 0.7
	# param1['seed'] = 0
	# num_rounds = 50

	plst = list(param2.items())
	xgtrain = xgb.DMatrix(train_X, label=train_y)
