...
cat_lagcols = ['segmento',"indrel_1mes","tiprel_1mes","ind_actividad_cliente"]
...
def income_cate(row):
    ...
    if 0 <= rent <= 60000:
        return 0
    if 60001 <= rent <= 120000:
        return 1
    if 120001 <= rent <= 180000:
        return 2
    if 180001 <= rent <= 240000:
        return 3
    if 240001 <= rent:
        return 4
    return 5

def processDataMK(in_file_name, cust_dict, lag_cust_dict, total_dict, lag_feature):
    x_vars_list = []
    y_vars_list = []
    ...
    for row in csv.DictReader(in_file_name):
        ...
        if row['fecha_dato'] == '2016-06-28':
            ...
            x_vars_list.append(x_vars + prev_target_list + lag_target_list + total_list+lag_feature_list)
    ...
    return x_vars_list, y_vars_list, cust_dict, lag_cust_dict, total_dict
...
if __name__ == "__main__":
    ...
    x_vars_list, y_vars_list, cust_dict, lag_cust_dict,total_dict = processDataMK(train_file, {}, {},{},{})
    print('Finished file processing')
    # np.save("trainx_newfeat.npy",x_vars_list)
    # np.save("trainy_newfeat.npy",y_vars_list)
    # x_vars_list = np.load("/Users/xiaofeifei/GitHub/Deep-Learning/trainx_newfeat.npy").tolist()
    # y_vars_list = np.load("/Users/xiaofeifei/GitHub/Deep-Learning/trainy_newfeat.npy").tolist()
    ...
    # x_vars_list, y_vars_list, cust_dict, lag_cust_dict,total_dict = processDataMK(test_file, cust_dict, lag_cust_dict,total_dict)
    # np.save("testx_newfeat.npy",x_vars_list)
    #
