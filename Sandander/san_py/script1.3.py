...
def processDataMK(in_file_name, cust_dict, lag_cust_dict,total_dict,lag_feature,lag1):
    x_vars_list = []
    y_vars_list = []
    ...
    return x_vars_list, y_vars_list, cust_dict, lag_cust_dict,total_dict,lag_feature,lag1
...
if __name__ == "__main__":
	...
	x_vars_list, y_vars_list, cust_dict, lag_cust_dict, total_dict,lag_feature,lag_target_list1 = processDataMK(train_file, {}, {},{},{},{})
	...
	x_vars_list, y_vars_list, cust_dict, lag_cust_dict, total_dict,lag_feature,lag_target_list1 = processDataMK(test_file, cust_dict, lag_cust_dict,total_dict,lag_feature,lag_target_list1)
