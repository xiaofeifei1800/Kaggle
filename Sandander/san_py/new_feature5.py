...
def processDataMK(in_file_name, cust_dict, lag_cust_dict,total_dict,lag1,lag2,lag_feature):
    x_vars_list = []
    y_vars_list = []

    for row in csv.DictReader(in_file_name):
        if row['fecha_dato'] not in ['2015-01-28','2015-03-28', '2015-04-28','2015-05-28', '2015-06-28', '2016-01-28',
        ...
        if row['fecha_dato'] == '2016-06-28':
            ...
            x_vars_list.append(x_vars + prev_target_list + lag_target_list+total_list+lag_target_list1+lag_target_list2+
                               lag_feature_list)
            ...
            if sum(new_products) > 0:
                for ind, prod in enumerate(new_products):
                    if prod>0:
                        ...
                        x_vars_list.append(x_vars+prev_target_list+lag_target_list+total_list+lag_target_list1+
                                           lag_target_list2+lag_feature_list)
                        y_vars_list.append(ind)


    return x_vars_list, y_vars_list, cust_dict, lag_cust_dict,total_dict,lag1,lag2,lag_feature
...
if __name__ == "__main__":
	...
	x_vars_list, y_vars_list, cust_dict, lag_cust_dict,total_dict,lag1,lag2, lag_feature = \
	...
	x_vars_list, y_vars_list, cust_dict, lag_cust_dict,total_dict,lag1,lag2,lag_feature = \
        processDataMK(test_file, cust_dict, lag_cust_dict,total_dict,lag1,lag2,lag_feature)
